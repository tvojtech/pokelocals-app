...
export function xmlToObject(xmlString: string): XmlTournament {
  ...
  const tournament: XmlTournament = {
    ...
    data: {
      name: jsonData.tournament.data.name?.toString(),
      id: jsonData.tournament.data.id?.toString(),
      city: jsonData.tournament.data.city?.toString(),
      state: jsonData.tournament.data.state?.toString() || null,
      country: jsonData.tournament.data.country?.toString(),
      ...
      organizer: {
        popid: jsonData.tournament.data.organizer?.['@_popid']?.toString(),
        name: jsonData.tournament.data.organizer?.['@_name']?.toString(),
      },
